...
from userbot.utils import fighterbot_cmd, edit_or_reply, sudo_cmd

GENIUS = os.environ.get("GENIUS_API_TOKEN", None)


@borg.on(fighterbot_cmd(outgoing=True, pattern="lyrics (.*)"))
...
@borg.on(fighterbot_cmd(outgoing=True, pattern="glyrics(?: |$)(.*)"))
