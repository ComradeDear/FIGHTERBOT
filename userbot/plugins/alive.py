ea by @(Sipakisking) && @Hell boy_pikachu
...
from userbot.utils import fighter_cmd, edit_or_reply, sudo_cmd
...
if HELL_PIC is None:
    HELL_IMG = "https://telegra.ph/file/3bc2b89fd6fe407ebcaeb.jpg"
else:
    HELL_IMG = HELL_PIC

CAT_IMGE = os.environ.get("CAT_IMGE", None)
if CAT_IMGE is None:
    CAT_IMG = "https://telegra.ph/file/3bc2b89fd6fe407ebcaeb.jpg
else:
    CAT_IMG = CAT_IMGE
...
@borg.on(fighter_cmd(outgoing=True, pattern="salive"))
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        ...
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](soon)\n"
        )
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](soon)\n"
        )
        pm_caption += "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  : [AGPL-3.0  ʟɪᴄᴇɴꜱᴇ](https://jenaatul8.wixsite.com/hellboi-atul)\n"
        pm_caption += "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ FIGHTERBOT ](soon)\n"
        ...
        return
    req = requests.get("https://telegra.ph/file/3bc2b89fd6fe407ebcaeb.jpg")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            ...
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](https://t.me/fighterbot_support)\n"
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](https://t.me/fighterbot_channel)\n"
            "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  : [AGPL-3.0  ʟɪᴄᴇɴꜱᴇ](https://jenaatul8.wixsite.com/hellboi-atul)\n"
            "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ вℓα¢к ℓιgнтηιηg ](https://t.me/fighterbot_support)\n"
            "[ ┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/blacklightningot)",
            link_preview=False,
        )
        await salive.delete()
...
pm_caption += "⚠️CHANNEL⚠️   : [ᴊᴏɪɴ](https://t.me/fighterbot_support)\n"

pm_caption += "🔥CREATOR🔥    : [Nub Here](https://t.me/krish1303y)\n\n"

pm_caption += "    [✨REPO✨](https://github.com/ComradeDear/FIGHTERBOT) 🔹 [📜License📜](https://github.com/KeinShin/Black-Lightning/blob/master/LICENSE)"


@borg.on(fighter_cmd(outgoing=True, pattern="halive$"))
...
@borg.on(fighter_cmd(outgoing=True, pattern="calive$"))
...
CMD_HELP.update(
    {
        ...
        \n\n**Syntax : **`.alive `\
        \n**Function : **__ .FIGHTERBOT Uerbot's Alive.__\
        \n\n**Syntax : **`.awake `\
