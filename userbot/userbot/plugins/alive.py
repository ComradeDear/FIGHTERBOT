...
if ALIVE_PIC is None:
    PM_iMG = "https://telegra.ph/file/d8d194c18562472a7c1f1.jpg"
else:
    PM_iMG = ALIVE_PIC
...
if HELL_PIC is None:
    HELL_IMG = "https://telegra.ph/file/d8d194c18562472a7c1f1.jpg"
else:
    HELL_IMG = HELL_PIC

CAT_IMGE = os.environ.get("CAT_IMGE", None)
if CAT_IMGE is None:
    CAT_IMG = "https://telegra.ph/file/d8d194c18562472a7c1f1.jpg"
else:
    CAT_IMG = CAT_IMGE
...
catversion = "3.0"
ALIVE_MSG = Config.ALIVE_MSG or "✮ HELLO MASTER I AM RUNNING SUCCESSFULLY ✮"
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        pm_caption = "**FIGHTERBOT 𝙸𝚂 🅾︎🅽🅻🅸🅽🅴**\n"
        pm_caption += f"**𝕄𝕪 𝔹𝕠𝕤𝕤**            : {DEFAULTUSER}\n"
        pm_caption += "𝚃𝙴𝙻𝙴𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽        : 1.17.5\n"
        pm_caption += "𝙿𝚈𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽          : 3.9.0\n"
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](https://t.me/fighterbot_channel)\n"
        )
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](https://t.me/fighterbot_support)\n"
        )
        pm_caption += "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  : [AGPL-3.0  ʟɪᴄᴇɴꜱᴇ](https://jenaatul8.wixsite.com/hellboi-atul)\n"
        pm_caption += "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ FIGHTERBOT ](https://t.me/fighterbot_channel)\n"
        ...
        return
    req = requests.get("https://telegra.ph/file/d8d194c18562472a7c1f1.jpg")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            ...
            "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ FIGHTERBOT ](https://t.me/dear_comradee)\n"
            "[ ┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/blacklightningot)",
            link_preview=False,
        )
        await salive.delete()
...
pm_caption = "__**🔥🔥FIGHTERBOT ɨs օռʟɨռɛ🔥🔥**__\n\n"
...
pm_caption += f"FIGHTERBOT      : __**{hellversion}**__\n"

pm_caption += f"⚜️Sudo⚜️            : `{sudou}`\n"

pm_caption += "⚠️CHANNEL⚠️   : [ᴊᴏɪɴ](https://t.me/fighterbot_support)\n"

pm_caption += "🔥CREATOR🔥    : [Nub Here](https://t.me/dear_comradee)\n\n"
...
async def amireallyalive(calive):
    ...
    if PM_IMG:
        ...
        pm_caption += f"**{EMOJI} FIGHTERBOT Version :** `{catversion}`\n"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} FIGHTERBOT Version :** `{catversion}`\n"
...
CUSTOM_ALIVE = (
    Var.CUSTOM_ALIVE
    if Var.CUSTOM_ALIVE
    else "Hey! I'm alive. I AM RUNNING SMOOTHLY!"
)
